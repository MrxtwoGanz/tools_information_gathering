...
sudo wget -q https://raw.githubusercontent.com/mrxtwo/tools_information_gethering/main/enc_sigit.py -O /usr/local/bin/sigit && sudo chmod +x /usr/local/bin/sigit
